...
function RegisterPage() {
  ...
  return (
    <div className=" bg-zinc-800 max-w-lg p-10 rounded-md max-h-fit m-auto my-20 text-zinc-300">
      ...
      >
        ...
        <input className=" text-zinc-400" type="file" {...register("photo", { required: true })} onChange={(e)=>setPhoto(e.target.files[0])} accept="image/*"/>  
      ...
      <input {...getInputProps()} accept=".pdf"/>
      {
        ...
        <p>You already have a acount? <a href="/register" className=" text-blue-500"> Sign in</a> </p>
      </form>
    </div>
  );
}
